...
void ATestGameCharacter::UpdateAnimation()
{
...
void ATestGameCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// Jump on any touch
	Jump();
...
void ATestGameCharacter::UpdateCharacter()
{
